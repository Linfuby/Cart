...
class Query extends \Parishop\ORMWrappers\Query
{
    ...
    {
        return array_merge($preload, array('options.size', 'options.girth', 'productImages', 'actions', 'season', 'brand', 'mainColor'));
    }
