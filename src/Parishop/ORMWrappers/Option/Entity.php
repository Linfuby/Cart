 ...
 * @property \PHPixie\ORM\Relationships\Type\OneTo\Type\Many\Property\Entity\Items $shopRests
 ...
 * @method \PHPixie\ORM\Loaders\Loader\Proxy\Editable orderProducts()
 ...
 * @method \Parishop\ORMWrappers\ShopRest\Entity[] shopRests()
...
class Entity extends \Parishop\ORMWrappers\Entity
{
    ...
    {
        return $this->actions()->offsetExists(0);
    }
    ...
    public function quantity_stock()
    {
        if(!$this->quantity_stock) {
            /**
             * @var \Parishop\ORMWrappers\ShopRest\Entity $rest
             */
            foreach($this->shopRests() as $rest) {
