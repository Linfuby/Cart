...
class Entity extends \Parishop\ORMWrappers\Entity
{
    ...
    /**
     * @param $optionId
     * @return \Parishop\ORMWrappers\RestOption\Entity
     */
    public function rest($optionId)
    {
        return $this->builder->components()->orm()->shopRest->relatedTo('option', $optionId)->relatedTo(
            'shop', $this->id()
        )->findOne();
    }

    public function restOptions($id)
    {
        //TODO-Linfuby
        return true;
    }

    public function url($url = array(), $query = array(), $resolverPath = 'app.shop')
    {
        return parent::url(
            array_merge(
                array(
